...
<table>
  ...
  <tbody>
    <tr>
      ...
      <strong>TB2:</strong> <p align="justify">He sustentado los avances finales de la arquitectura del sistema ante el equipo y los evaluadores, explicando de manera clara cómo la implementación de la arquitectura orientada a microservicios y el diseño guiado por el dominio (DDD) soportan la escalabilidad del monitoreo IoT y la IA predictiva. Adapté el nivel técnico de la exposición para asegurar la total comprensión de las decisiones técnicas por parte de todos los involucrados.</p><br>
      <strong>TF:</strong> <p align="justify">Para el Trabajo Final (TF), lideré la sustentación definitiva del proyecto ante el jurado evaluador. Expuse con fluidez cómo nuestra arquitectura basada en microservicios y DDD resolvió los desafíos de escalabilidad del monitoreo IoT y la IA predictiva. Adapté mi discurso y el nivel de detalle técnico al responder las rondas de preguntas, asegurando que tanto los perfiles orientados a negocio como los puramente técnicos comprendieran el valor y la solidez de la solución.</p><br>
      ...
      <strong>TP:</strong> <p align="justify">Participé en la explicación del diseño táctico del sistema, presentando al equipo cómo los bounded contexts seleccionados se transforman en módulos internos con responsabilidades específicas. Durante las coordinaciones, expuse la relación entre monitoreo, alertas e inteligencia predictiva, aclarando cómo cada capa contribuye al funcionamiento general de OnControl y cómo estos módulos se conectan con la arquitectura previamente definida.</p><br>
      <strong>TB2:</strong> <p align="justify">Durante el desarrollo de TB2, participé en las coordinaciones del equipo explicando los avances realizados de manera clara y ordenada. Procuré comunicar mis ideas con objetividad, adaptando el lenguaje utilizado para que todos los integrantes pudieran comprender los acuerdos, observaciones y mejoras necesarias para la entrega. Asimismo, apoyé en la sustentación interna de los contenidos desarrollados, reforzando la comprensión general del proyecto.</p><br>
      <strong>TF:</strong> <p align="justify">Durante la sustentación final, expuse con claridad el diseño táctico implementado, justificando las decisiones detrás de la integración de los Bounded Contexts y el flujo de mensajes del dominio. Adapté la terminología técnica para asegurar que tanto el jurado como los stakeholders comprendieran el impacto de nuestra lógica de negocio en la eficiencia de OnControl.</p><br>
      ...
      <strong>TB2:</strong> <p align="justify">En TB2, mantuve una comunicación constante con mis compañeros para coordinar el desarrollo de las secciones asignadas y resolver dudas relacionadas con la integración del informe. Expuse mis aportes de forma clara, buscando que las ideas sean entendidas por el equipo sin depender de explicaciones demasiado técnicas. Esto permitió mejorar la organización del trabajo y asegurar una comprensión común de los avances realizados.</p><br>
      <strong>TF:</strong> <p align="justify">Participé en la exposición final defendiendo las decisiones de diseño a nivel de componentes y mapeo de contextos. Comuniqué de manera efectiva cómo la arquitectura propuesta soporta la interacción fluida entre pacientes, médicos y dispositivos IoT, respondiendo a las preguntas del jurado con un lenguaje claro, seguro y objetivo.</p><br>
      ...
      <strong>TB2:</strong> <p align="justify">Participé en la sustentación de la arquitectura final de OnControl, explicando la distribución de los contenedores, el despliegue de los servicios y la comunicación entre las aplicaciones, los microservicios y los dispositivos IoT. Durante la exposición respondí las consultas relacionadas con la infraestructura tecnológica y adapté la explicación para que las decisiones arquitectónicas fueran comprendidas por públicos con diferentes niveles de conocimiento técnico.</p><br>
      <strong>TF:</strong> <p align="justify">En la sustentación del Trabajo Final, expliqué detalladamente la infraestructura y el diagrama de despliegue del sistema en producción. Logré transmitir de manera comprensible cómo se comunican las aplicaciones cliente con los microservicios y la base de datos en la nube, resolviendo las dudas técnicas de los evaluadores con precisión y adaptando el mensaje a la audiencia.</p><br>
      ...
      <strong>TF:</strong> <p align="justify">Durante la presentación del proyecto final, sustenté cómo el diseño de las interfaces y la experiencia de usuario (UX/UI) responden directamente a los hallazgos de las entrevistas con los usuarios. Comuniqué claramente el valor del producto desde la perspectiva del cliente, conectando las necesidades del usuario con la solución tecnológica desarrollada.</p><br>
      </td>
      <td>
        <strong>TB1:</strong><br>
        Nos hemos enfocado en mantener una alta claridad en nuestros diseños y explicaciones, lo que ayudó en el desarrollo de los gráficos y en la comprensión general de la arquitectura tecnológica del proyecto.<br><br>
        <strong>TP:</strong><br>
        Nos hemos enfocado en mantener la claridad y compresión durante toda la parte de nuestro trabajo, siempre teniendo un enfoque en la facilidad de compresión de nuestro proyecto.<br><br>
        <strong>TB2:</strong><br>
        El grupo se ha enfocado en que el entendimiento del informe sea lo más importante, con gráficos, explicaciones y resumenes detallados pero sin estar llenos de información que pueda confundir.<br><br>
        <strong>TF:</strong><br>
        Demostramos la capacidad de defender y sustentar oralmente un proyecto arquitectónico complejo frente a un jurado, adaptando nuestra comunicación colectiva para validar tanto la viabilidad técnica como el impacto en el negocio.
      </td>
    </tr>
    <tr>
      ...
      <td>
        ...
        <strong>TB2:</strong> <p align="justify">Consolidé y refiné la documentación técnica de la entrega final, detallando los contratos de comunicación entre los microservicios y la especificación de los Bounded Contexts definitivos. Me aseguré de estructurar el informe con un lenguaje objetivo y formal, garantizando que tanto los desarrolladores como el público con perfil de negocio puedan interpretar el funcionamiento integral del sistema OnControl sin ambigüedades.</p><br>
        <strong>TF:</strong> <p align="justify">Fui el encargado de la consolidación y revisión final del informe técnico del proyecto OnControl. Redacté las conclusiones arquitectónicas definitivas y los detalles de despliegue en producción, manteniendo una estructura formal y objetiva. Me aseguré de que el documento final utilice un lenguaje preciso y cohesionado, permitiendo que cualquier ingeniero o stakeholder de negocio pueda interpretar el funcionamiento integral del sistema sin ambigüedades.</p><br>
        <strong>Barrutia Vaez, Ricardo Andree</strong> <br>
        ...
        <strong>TB2:</strong> <p align="justify">Para TB2, contribuí en la redacción, revisión y organización de la documentación del proyecto, procurando que los contenidos mantengan coherencia con la estructura general del informe. Mi aporte se enfocó en presentar la información de manera objetiva, ordenada y comprensible para distintos tipos de lectores, evitando ambigüedades y asegurando que las secciones desarrolladas se integren correctamente con el resto del trabajo.</p><br>
        <strong>TF:</strong> <p align="justify">Redacté la versión definitiva de la documentación del diseño táctico y las responsabilidades de los módulos de OnControl. Me aseguré de que el documento final presentara una narrativa coherente y objetiva, unificando los diagramas de flujo de dominio con explicaciones claras que sirvan de guía sólida para cualquier futuro desarrollador o evaluador del proyecto.</p><br>
        <strong>Espinoza Inoñan, Fabiola Ximena</strong> <br>
        ...
        <strong>TB2:</strong> <p align="justify">Durante TB2, participé en la elaboración y mejora de la documentación escrita, cuidando que las explicaciones fueran claras, formales y alineadas con los objetivos del proyecto. También apoyé en la revisión de contenidos para mantener una redacción coherente y entendible, permitiendo que la información presentada pueda ser interpretada adecuadamente por audiencias con distintos niveles de conocimiento técnico.</p><br>
        <strong>TF:</strong> <p align="justify">Consolidé la documentación escrita referente a la arquitectura de datos, patrones CQRS y diagramas de componentes en la entrega final. Revisé exhaustivamente el formato y la redacción técnica para entregar un informe profesional, objetivo y sin ambigüedades, que refleja con exactitud la estructura tecnológica de OnControl.</p><br>
        <strong>Espejo Gamarra, Bryan Ronnald</strong> <br>
        ...
        <strong>TF:</strong> <p align="justify">Finalicé la redacción técnica sobre la vista de despliegue y distribución de contenedores para el documento final. Empleé un lenguaje técnico pero accesible para describir la infraestructura en la nube, asegurando que la documentación cumpla con los estándares de ingeniería exigidos y sea fácilmente interpretable por cualquier perfil técnico.</p><br>
        <strong>Ramos Mendoza, Juan Pablo</strong> <br>
        ...
        <strong>TF:</strong> <p align="justify">Documenté de forma integral el proceso de validación con usuarios y las iteraciones de diseño de las interfaces para el entregable final. Sinteticé los resultados de las entrevistas y las decisiones de diseño en un formato claro y conciso, facilitando la comprensión del impacto de la solución a nivel de negocio y usabilidad.</p><br>
      </td>
      <td>
        <strong>TB1:</strong><br>
        A través de los resultados de nuestras pruebas y diseños anteriores hemos podido documentar y explicar el proceso de desarrollo de nuestro proyecto para tenerlo como base consolidada para todo el equipo.<br><br>
        <strong>TP:</strong><br>
        Gracias al enfoque en la claridad de nuestras explicaciones y diagramas hemos podido tener una visión muy clara del objetivo que deseamos realizar através de este proyecto.<br><br>
        <strong>TB2:</strong><br>
        Enfocándose en la claridad de nuestro proyecto y del sprint realizado hemos desarrollado el informe para una fácil y correcta revisión.<br><br>
        <strong>TF:</strong><br>
        El informe final evidencia un alto nivel de madurez en la comunicación escrita, logrando compilar todas las decisiones técnicas y de arquitectura en un documento unificado, estructurado y accesible para múltiples audiencias.
      </td>
    </tr>
  </tbody>
</table>
