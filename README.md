    ...
    <tr>
      ...
      <td>
        <strong>Holguín Gamarra, Hardie Alfonso</strong> <br>
         ...
         <strong>TP:</strong> <p align="justify">Al estructurar nuestro proyecto de forma clara hemos tenido una facilidad de explicar cada paso del proyecto hacia el resto de los miembros.</p><br><strong>TB2:</strong> <p align="justify">Consolidé y refiné la documentación técnica de la entrega final, detallando los contratos de comunicación entre los microservicios y la especificación de los Bounded Contexts definitivos. Me aseguré de estructurar el informe con un lenguaje objetivo y formal, garantizando que tanto los desarrolladores como el público con perfil de negocio puedan interpretar el funcionamiento integral del sistema OnControl sin ambigüedades.</p><br>
        <strong>Barrutia Vaez, Ricardo Andree</strong> <br>
