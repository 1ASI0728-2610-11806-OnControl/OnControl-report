...
**ABET – EAC - Student Outcome NUMERO **<br><br>
**Criterio:** CONTENIDO
...
- **Organización en GitHub**: [OnControl](https://github.com/OnControl-IOT)
- **Repositorio del Landing Page**: [OnControl Landing Page](https://github.com/OnControl-IOT/LandingPage)
...
- Como ya se ha mencionado, la gestión de nuestro código fuente se realizará a través de GitHub. Asimismo, se utilizará GitHub Pages para la publicación y despliegue de la página. Cada sección del Landing Page que se ha creado deberá aparecer en el siguiente vínculo:
  https://oncontrol-iot.github.io/LandingPage/
...
En esta sección se muestra el avance correspondiente al Sprint 2, donde se planifica el desarrollo del backend y los endpoints
...
Video de exposición TF1: https://drive.google.com/file/d/1xxQeLdl5GrTIRE2DjVnw-O0olqUJ8-Uq/view?usp=sharing
